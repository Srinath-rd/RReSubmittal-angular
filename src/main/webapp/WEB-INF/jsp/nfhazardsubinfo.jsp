<div>
    ...
    <div class="form-group row">
        ...
        <div class="col-xs-2">
            <button type="button" class="btn btn-xs btn-info"
                    id="hazard-sublist-plus-btn">Add
            </button>
            <button type="button" class="btn btn-xs btn-danger"
                    id="hazard-sublist-minus-btn">Remove
                <!--
    ...
    <div class="form-horizontal text-center">
        ...
        <button type="submit" value="Cancel" name="_cancel"
                class="btn btn-xs btn-primary " id="hzrdInfoSaveBtn">Save and Exit
        </button>
        <button type="submit" value="Cancel" name="_cancel"
                class="btn btn-xs btn-primary " id="hzrdInfoCancelBtn">Cancel
        </button>
        <button type="submit" value="Previous" name="_previous"
                class="btn btn-xs btn-primary " id="hzrdInfoToRespPartyInfoBtn">Previous
        </button>
        <button type="submit" value="Next" name="_target1"
                class="btn btn-xs btn-primary " id="hzrdInfoToImpctsInfoBtn">Next
        </button>
    </div>
</div>
